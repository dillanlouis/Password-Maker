...
string thirtytwo_combo(const string &, long long &, const char *, char *);
string thirtythree_combo(const string &, long long &, const char *, char *);
string thirtyfour_combo(const string &, long long &, const char *, char *);
